        ...
        Try
            ...
            If sStatus.Trim = "O" Then
                ...
                If dtDatos.Rows.Count > 0 Then
                    Omercancias = CType(objGlobal.compañia.GetBusinessObject(BoObjectTypes.oInventoryGenExit), Documents)
                    ...
                    For Each MiDataRow As DataRow In dtDatos.Rows
                        If sDocEntryCerrar <> MiDataRow("DocEntry").ToString Then
                            ...
                            If sStatusCerrar = "O" Then
                                ...
                                'Close UDO record
                                oGeneralParams = CType(oGeneralService.GetDataInterface(SAPbobsCOM.GeneralServiceDataInterfaces.gsGeneralDataParams), GeneralDataParams)
